  ...
  return (
    <section id="review" className="my-20 dark:bg-slate-900">
     <div className="container">
      ...
      <h2 className="text-3xl lg:text-4xl mt-1 text-center text-slate-900 font-bold hover:text-orange-400 dark:text-white">Penilaian Produk</h2>
          ...
          <SwiperSlide>
            <article>
                <div className="flex items-center mb-4 space-x-4">
                    ...
                    <div className="space-y-1 font-medium dark:text-white">
                        <p>Marchel Louw
                            <span className="block text-sm text-gray-500 dark:text-gray-400">Pembeli : Makanan Kucing Bolt</span></p>
                    </div>
                </div>
                <div className="flex items-center mb-1">
                    <img src={star} alt="star" />
                    ...
                    <h3 className="ml-2 text-sm font-semibold text-gray-900 dark:text-white">Cukup Memuaskan</h3>
                </div>
                <footer className="mb-5 text-sm text-gray-500 dark:text-gray-400">
                    <p>Berkomentar pada tanggal <time datetime="2020-02-21 18:00">21 Februari 2020</time></p></footer>
                <p className="mb-2 font-light text-gray-500 dark:text-gray-400">Pengantarannya sangat baik. Makanan datang dengan aman.
                <br />Kucing saya sangat suka!!</p>
                <aside>
                    <p className="mt-6 text-xs text-gray-500 dark:text-gray-400">10 orang terbantu dengan komentar ini</p>
                    <div className="flex items-center mt-3 space-x-3 divide-x divide-gray-200 dark:divide-gray-600">
                        <a href="#home" className="text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-xs px-2 py-1.5 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700">Membantu</a>
                        <a href="#home" className="pl-4 text-sm font-medium text-blue-600 hover:underline dark:text-blue-500">Laporkan Penyalahgunaan</a>
                    </div>
          ...
          <SwiperSlide>
            <article>
                <div className="flex items-center mb-4 space-x-4">
                    ...
                    <div className="space-y-1 font-medium dark:text-white">
                        <p>Lucia Lamora
                            <span className="block text-sm text-gray-500 dark:text-gray-400">Pembeli : Rumah Hamster Pink</span></p>
                    </div>
                </div>
                <div className="flex items-center mb-1">
                    <img src={star} alt="star" />
                ...
                <footer className="mb-5 text-sm text-gray-500 dark:text-gray-400">
                    <p>Berkomentar pada tanggal <time datetime="2022-11-2 18:00">02 November 2022</time></p></footer>
                <p className="mb-2 font-light text-gray-500 dark:text-gray-400">Untung rumahnya tidak lecet. 
                <br />Sangat bagus untuk tempat tinggal hamsterku~</p>
                <aside>
                    <p className="mt-6 text-xs text-gray-500 dark:text-gray-400">17 orang terbantu dengan komentar ini</p>
                    <div className="flex items-center mt-3 space-x-3 divide-x divide-gray-200 dark:divide-gray-600">
                        <a href="#home" className="text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-xs px-2 py-1.5 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700">Membantu</a>
                        <a href="#home" className="pl-4 text-sm font-medium text-blue-600 hover:underline dark:text-blue-500">Laporkan Penyalahgunaan</a>
                    </div>
